...
double MarkerOptimal::_f(int i, int n, double total, double sum) const
{
...
void MarkerOptimal::write(std::string outfilename, std::string datatype)
{
  _mark();
